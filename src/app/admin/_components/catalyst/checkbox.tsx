	...
	return (
		<Headless.Field
			...
			className={cn(
				...
				// Control layout
				'*:data-[slot=control]:col-start-1 *:data-[slot=control]:mt-0.75 sm:*:data-[slot=control]:mt-1',
				// Label layout
...
const base = cn([
	...
	'before:bg-input before:absolute before:inset-0 before:-z-10 before:rounded-[calc(0.3125rem-1px)] before:shadow-sm',
	...
	// Border
	'border border-zinc-950/15 group-data-checked:border-transparent group-data-checked:bg-(--checkbox-checked-border) group-data-hover:border-zinc-950/30 group-data-hover:group-data-checked:border-transparent',
	...
	// Focus ring
	'group-data-focus:outline-interactive group-data-focus:outline-2 group-data-focus:outline-offset-2',
	// Disabled state
	'group-data-disabled:not-group-data-readonly:opacity-50',
	'dark:group-data-disabled:not-group-data-readonly:border-white/20 dark:group-data-disabled:not-group-data-readonly:bg-white/2.5 dark:group-data-disabled:not-group-data-readonly:[--checkbox-check:var(--color-white)]/50 dark:group-data-checked:group-data-disabled:after:hidden',
	// Forced colors mode
	'forced-colors:[--checkbox-check:HighlightText] forced-colors:[--checkbox-checked-bg:Highlight] forced-colors:group-data-disabled:not-group-data-readonly:[--checkbox-check:Highlight]',
	'dark:forced-colors:[--checkbox-check:HighlightText] dark:forced-colors:[--checkbox-checked-bg:Highlight] dark:forced-colors:group-data-disabled:not-group-data-readonly:[--checkbox-check:Highlight]',
	'group-data-readonly:cursor-not-allowed',
])
