...
const colors = {
	...
	blue: 'bg-v2-red-500/15 text-blue-700 group-data-hover:bg-v2-red-500/25 dark:text-blue-400 dark:group-data-hover:bg-v2-red-500/25',
	indigo:
...
export function Badge({ color = 'zinc', className, ...props }: BadgeProps & Props<'span'>) {
	return (
		<span
			{...props}
			className={cn(
...
export const BadgeButton = forwardRef(function BadgeButton(
	...
	let classes = cn(
		className,
		'group data-focus:outline-interactive relative inline-flex rounded-md focus:not-data-focus:outline-hidden data-focus:outline-2 data-focus:outline-offset-2'
	)
