		...
		<TableRowContext.Provider
			...
			<tr
				...
				className={cn(
					className,
					href
						&& 'has-[[data-row-link][data-focus]]:outline-v2-red has-[[data-row-link][data-focus]]:outline-2 has-[[data-row-link][data-focus]]:-outline-offset-2 dark:focus-within:bg-white/2.5',
