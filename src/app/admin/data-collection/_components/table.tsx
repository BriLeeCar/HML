		...
		<TableRowContext.Provider
			...
			<tr
				...
				className={cn(
					className,
					href
						&& 'has-[[data-row-link][data-focus]]:outline-2 has-[[data-row-link][data-focus]]:-outline-offset-2 has-[[data-row-link][data-focus]]:outline-[#AC162B] dark:focus-within:bg-white/2.5',
