...
> [!ToDo] Before reaching out to the Support Team
>
> 1. Please read the [How-To](/get-ready-to-leave) information provided.
> 2. Review the guide explaining the differences between [traditional visa routes and the asylum path](/pdf/Traditional%20Paths%20v.%20Asylum.pdf){{target: "_blank", rel: "noopener"}}. Each has its own criteria and expectations, and it’s important to understand these in advance.
